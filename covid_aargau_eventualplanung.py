...
data = [
    ...
    {'Indikator': 'Operationen', 'Aktuell': 'KSA verschiebt nicht dringliche OP', '1. Eskalation': f'nicht dringl. OP verschoben {überschritten}', '2. Eskalation': f'dringl. und nicht dringl. OP verschoben {nicht_überschritten}', '3. Eskalation (Lockdown)': f'Notfall-OP gefährdet {nicht_überschritten}'}
]
